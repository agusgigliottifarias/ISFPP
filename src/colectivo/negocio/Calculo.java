...
/**
 * Capa de Negocio (Opción 7 - Conexión Peatonal).
...
public class Calculo {
    ...
    // ====================================================================
    // A) SOBRECARGA PARA TEST (5 ARGUMENTOS)
    // ====================================================================
    ...
    // ====================================================================
    // B) MÉTODO PRINCIPAL (8 ARGUMENTOS)
    // ====================================================================
    ...
    private void buscarRutaOptima(Parada origen, Parada destino, int diaServicio, LocalTime horaLlegaParada,
        ...
        // 2. RUTAS CON CONEXIÓN VEHICULAR (A->C en L1, C->B en L2)
        ...
        // 3. RUTAS CON CONEXIÓN PEATONAL (A->C en L1, Caminar C->D, D->B en L2)
    ...
    /**
     * Construye un objeto Recorrido a partir de una lista de tramos.
     */
    ...
    /**
     * Algoritmo BFS (Búsqueda en Anchura) para encontrar un camino de tramos.
     */
    ...
    // Agrupar tramos por ID de Línea (o "CAMINANDO")
