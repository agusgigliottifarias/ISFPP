    ...
    public Map<Integer, Parada> buscarTodos() {
        ...
        synchronized (this) {
            ...
            for (String s : lineas) {
                ...
                // formato esperado: id;nombre;[lat];[lon]
                if (a.length < 2) {
                ...
                // Parada mantiene id como String (según consigna de la profe)
                Parada p = new Parada(String.valueOf(id), nombre, lat, lon);
                out.put(id, p); // clave del mapa sigue siendo Integer (como exige el test)
            }
