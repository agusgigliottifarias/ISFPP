...
public class MainController {
    ...
    private ResourceBundle bundle; // <-- NUEVO: Guardar el bundle
    ...
    public void setCoordinador(CoordinadorApp coordinador) {
        ...
        this.bundle = coordinador.getConfig().getBundle(); // <-- NUEVO: Obtener el bundle
    ...
    private void cargarConsulta() {
        try {
            ...
            // --- LÍNEA MODIFICADA ---
            FXMLLoader loader = new FXMLLoader(url, this.bundle); // Inyectar bundle
