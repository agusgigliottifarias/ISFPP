...
public class ConsultaController implements Initializable {
    ...
    private void onCalcular() {
        ...
        // <<<<<<<< CAMBIO 2: La operación de cálculo se mueve a un hilo de fondo
        new Thread(() -> {
            ...
            // <<<<<<<< CAMBIO 3: Las actualizaciones de UI se ejecutan con Platform.runLater
            Platform.runLater(() -> {
                // El código dentro de Platform.runLater se ejecuta en el JavaFX Application Thread
                
                // Lógica de validación y presentación de resultados
