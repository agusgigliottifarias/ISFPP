...
public class ConsultaController implements Initializable {
    ...
    private ResourceBundle bundle; // <-- 4. Guardar el ResourceBundle
    ...
    // --- 5. USAR EL MÉTODO initialize DE INITIALIZABLE ---
    @Override
    public void initialize(URL location, ResourceBundle resources) {
        this.bundle = resources; // Guardar el bundle que nos pasa JavaFX
        
        // --- 6. TRADUCIR LOS DÍAS ---
        // (Usa las claves de tus archivos 'mensajes_xx.properties')
        ...
        // (El resto del método initialize permanece igual...)
    ...
    private void onCalcular() {
        ...
        if (alternativas == null || alternativas.isEmpty()) {
            ...
            var salientes = tramos.values().stream()
                    .filter(t -> t.getIdParadaOrigen().equals(origenId) && t.getIdLinea() != null) // Solo tramos de colectivo
                    .collect(Collectors.toList());
